 ...
 * @param {string} char
 */
export const setDefaultDelimiter = function (char: string)
{
 ...
 * @param char
 */
export const setDefaultSeparator = function (char: string)
{
...
const convertRawStringToNumber = function (input: string|number|bigint, {
    delimiter = OPTIONS.DEFAULT_DELIMITER,
    separator = OPTIONS.DEFAULT_SEPARATOR
} = {})
{
 ...
 * @returns {{result: string, floaters="": string, sign="": string, numbers: *[]}}}
 */
export const delimitNumber = function (input, {
    delimiter = OPTIONS.DEFAULT_DELIMITER,
    separator = OPTIONS.DEFAULT_SEPARATOR
} = {})
{
